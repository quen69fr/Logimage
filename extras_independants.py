...
liste = [('Entrees/Images/JoliesBouclesDoreille.png', "Jolies boucles d'oreille"),
         ...
         ('Entrees/Images/AuBordDeLeau.png', "Au bord de l'eau")]
...
pygame.init()
init_grille_derges(50, 100)

for chemin, titre_logimage in liste:
    creer_logimage_a_partir_png(chemin, titre_logimage, True)

# impr_dic_logimage_logimage_sequences('Entrees/Images/AuBordDeLeau.png', "Au bord de l'eau")
# creer_logimage_a_partir_png('Entrees/Images/AuBordDeLeau.png', "La paille au nez !")
